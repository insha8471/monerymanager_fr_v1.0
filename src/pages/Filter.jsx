...
const Filter = () => {
    ...
    const handleSearch = async (e) => {
        ...
        try {
            ...
            toast.error(error.response?.data?.message || "failed to fetch the transactions");
        }finally{
            setLoading(false);
        }
    }
    ...
    return (
        <Dashboard activateMenu="Filters">
                ...
                <div className="card p-4 mb-4">
                    ...
                    <form className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-6 gap-4">
                        <div className="">
                            ...
                            <select value={type} className="w-full border rounded px-3 py-2" onChange={e => setType(e.target.value)}>
                        ...
                        <div>
                            <label htmlFor="sortOrder"  className="block text-sm font-medium mb-1">sortOrder</label>
